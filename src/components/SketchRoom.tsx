  ...
  return (
    <div
      className="
        ...
        md:min-h-screen md:max-w-[1800px]
    ...
    >
      ...
      {/* ============ 窗框容器：点击进入 MAP（Gemini 的 Enter Map） ============ */}
      <div
        className="
          absolute
      ...
      {/* ============ 人物：点击进入 ABOUT（Gemini 的 About Me 页） ============ */}
      <div
        className="
          absolute
          top-[15%] left-[8%] w-[45%]
          md:top-[10%] md:left-[18%] md:w-[30%]
          aspect-[1/2] z-30 group
        "
      >
        <div className="relative w-full h-full">
          ...
          <div
            className="
              pointer-events-none absolute top-[50%] left-[50%] -translate-x-1/2
              z-40 opacity-0 group-hover:opacity-100 transition-opacity
            "
          >
      ...
      {/* ============ 右侧大植物（装饰） ============ */}
      <div className="absolute top-[50%] right-[4%] w-[25%] md:top-[55%] md:right-[4%] md:w-[25%] aspect-square pointer-events-none">
        <img
      ...
      {/* ============ 左侧大植物（装饰） ============ */}
      <div className="absolute top-[60%] right-[85%] w-20 md:top-[55%] md:right-[84%] md:w-[16%] aspect-square pointer-events-none">
        <img
          src="https://freight.cargo.site/t/original/i/R2687338830875631428905166402469/4334E9CDBA0A0143543C912F446E796A.png"
          alt="Plant"
          className="w-full h-full object-contain animate-[sway_4s_ease-in-out_infinite] origin-bottom"
      ...
      {/* ============ 左侧四叶草（装饰） ============ */}
      <div className="absolute top-[65%] right-[85%] w-[20%] md:top-[70%] md:right-[75%] md:w-[20%] aspect-square pointer-events-none">
        <img
      ...
      {/* ============ 书本：点击进入 RESEARCH（Gemini 的 Journal & Notes） ============ */}
      <div
        className="
          absolute
      ...
      {/* ============ 铃铛：点击进入 CONTACT（Gemini Contact 页） ============ */}
      <div
        className="
          absolute bottom-[1%] md:bottom-[1%]
          left-1/2 -translate-x-1/2
          w-20 md:w-28 cursor-pointer z-30 group
        "
